...
exports.subscriptionInvoiceTemplate = exports.reconciliationStatementTemplate = exports.payslipTemplate = exports.welcomeMailTemplate = exports.paymentReminderTemplate = exports.invoiceMailTemplate = exports.passwordResetTemplate = exports.emailVerificationTemplate = void 0;
...
`;
const button = (text, url) => `<a href="${url}" style="display:inline-block;padding:12px 28px;background:${BRAND_COLOR};color:#fff;text-decoration:none;border-radius:6px;font-size:15px;font-weight:600;">${text}</a>`;
const emailVerificationTemplate = (d) => ({
...
const paymentReminderTemplate = (d) => {
...
exports.welcomeMailTemplate = welcomeMailTemplate;
const payslipTemplate = (d) => ({
...
const reconciliationStatementTemplate = (d) => ({
...
exports.reconciliationStatementTemplate = reconciliationStatementTemplate;
const subscriptionInvoiceTemplate = (d) => ({
...
exports.subscriptionInvoiceTemplate = subscriptionInvoiceTemplate;
